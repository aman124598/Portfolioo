// Script to seed existing projects and experiences into the database
...
async function seed() {
  ...
  if (projectCount === 0) {
    ...
    console.log(`Projects table already has ${projectCount} entries, skipping...`);
  }
  ...
  if (experienceCount === 0) {
    ...
    console.log(`Experiences table already has ${experienceCount} entries, skipping...`);
  }
